 ...
 */
/*
 * Sector names as the eyebrow above the headline.
 *
 * The taxonomy labels are English because they are internal keys, and they
 * were being printed straight onto a Spanish page — a prospect in Málaga was
 * shown "Dental clinic" above their own name.
 */
const CATEGORY_LABEL_ES: Record<string, string> = {
  ...
  pharmacy: 'Farmacia',
  law_firm: 'Despacho de abogados',
  professional_services: 'Servicios profesionales',
  architecture: 'Arquitectura',
  real_estate: 'Inmobiliaria',
  hotel: 'Hotel',
  restaurant: 'Restaurante',
  cafe_bar: 'Cafetería y bar',
  beauty: 'Centro de belleza',
  spa_wellness: 'Spa y bienestar',
  fitness: 'Centro deportivo',
  private_education: 'Centro de formación',
  travel_agency: 'Agencia de viajes',
  car_dealer: 'Concesionario',
  jewellery: 'Joyería',
  optician: 'Óptica',
  yacht_charter: 'Alquiler de embarcaciones',
  wedding_events: 'Bodas y eventos',
...
export function buildConcept(detail: BusinessDetail, claude: ClaudeAnalysis | null): DemoConcept {
  ...
  return {
    ...
    categoryLabel: CATEGORY_LABEL_ES[category.key] ?? category.label,
    accent: theme.accent,
    theme,
    media: {
      hero: media[0] ?? null,
